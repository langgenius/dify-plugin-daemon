...
func (app *App) pluginManagementGroup(group *gin.RouterGroup, config *app.Config) {
	...
	group.POST("/blue_green/approve", controllers.ApproveBlueGreen)
	group.POST("/blue_green/force_offline", controllers.ForceOfflineRuntime)
	group.POST("/blue_green/rollback", controllers.RollbackBlueGreen)
