...
var PluginDispatchers = []PluginDispatcher{
	...
	{
		Name:               "DatasourceGetOnlineDriverFileList",
		RequestType:        requests.RequestGetOnlineDriverFileList{},
		ResponseType:       datasource_entities.GetOnlineDriverFileListResponse{},
		AccessType:         access_types.PLUGIN_ACCESS_TYPE_DATASOURCE,
		AccessAction:       access_types.PLUGIN_ACCESS_ACTION_INVOKE_ONLINE_DRIVER_GET_FILE_LIST,
		AccessTypeString:   "access_types.PLUGIN_ACCESS_TYPE_DATASOURCE",
		AccessActionString: "access_types.PLUGIN_ACCESS_ACTION_INVOKE_ONLINE_DRIVER_GET_FILE_LIST",
		BufferSize:         1,
		Path:               "/datasource/get_online_driver_file_list",
	},
	{
		Name:               "DatasourceGetOnlineDriverFile",
		RequestType:        requests.RequestGetOnlineDriverFile{},
		ResponseType:       datasource_entities.DataSourceResponseChunk{},
		AccessType:         access_types.PLUGIN_ACCESS_TYPE_DATASOURCE,
		AccessAction:       access_types.PLUGIN_ACCESS_ACTION_INVOKE_ONLINE_DRIVER_GET_FILE,
		AccessTypeString:   "access_types.PLUGIN_ACCESS_TYPE_DATASOURCE",
		AccessActionString: "access_types.PLUGIN_ACCESS_ACTION_INVOKE_ONLINE_DRIVER_GET_FILE",
		BufferSize:         1,
		Path:               "/datasource/get_online_driver_file",
	},
}
