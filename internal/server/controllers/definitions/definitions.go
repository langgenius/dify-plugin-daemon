...
var PluginDispatchers = []PluginDispatcher{
	...
	{
		Name:               "TriggerInvoke",
		RequestType:        requests.TriggerInvokeRequest{},
		ResponseType:       requests.TriggerInvokeResponse{},
		AccessType:         access_types.PLUGIN_ACCESS_TYPE_TRIGGER,
		AccessAction:       access_types.PLUGIN_ACCESS_ACTION_INVOKE_TRIGGER,
		AccessTypeString:   "access_types.PLUGIN_ACCESS_TYPE_TRIGGER",
		AccessActionString: "access_types.PLUGIN_ACCESS_ACTION_INVOKE_TRIGGER",
		BufferSize:         512,
		Path:               "/trigger/invoke",
	},
	{
